...
public class HistorialCuenta_Controller {
    ...
    public void verPagoAlumno() {
        if (alumnoServiceImplement.buscarAlumno().size() <= 0) {
            System.out.println("------------------------------------------------------------------");
            System.out.println("no hay alumnos guardados en base de datos");
            System.out.println("primero agrege alumnos en el sistema");
            System.out.println("------------------------------------------------------------------");
        } else {
    ...
    public void verPagoCurso() {
        ...
        if (listaCursos.size() > 0) {
            try {
                ...
                for (int i = 0; i < listaCursos.size(); i++) {
                    int elemento = i + 1;
                    System.out.println("Elemento " + elemento + ": " + listaCursos.get(i).toString());
                }
                System.out.print("elemento Nº ");
                int i_curso = sc.nextInt();
    ...
    public void buscarPagoPorId() {
        ...
        if (listaPagos.size() > 0) {
            ...
            System.out.println("------------------------------------------------------------------");
            System.out.println("no hay pagos guardados en base de datos");
            System.out.println("------------------------------------------------------------------");
        }
    }
